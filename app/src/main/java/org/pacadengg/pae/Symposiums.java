...
public class Symposiums extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer = findViewById(R.id.drawerSymposiums);
        naviView = findViewById(R.id.naviViewSymposiums);
